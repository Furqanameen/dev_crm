...
class Admin::SchedulesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get materialize" do
    get admin_schedules_materialize_url
    assert_response :success
  end

  test "should get send_now" do
    get admin_schedules_send_now_url
    assert_response :success
  end

  test "should get pause" do
    get admin_schedules_pause_url
    assert_response :success
  end
end
